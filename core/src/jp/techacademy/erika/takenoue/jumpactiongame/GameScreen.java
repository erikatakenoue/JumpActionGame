package jp.techacademy.erika.takenoue.jumpactiongame;
...
public class GameScreen extends ScreenAdapter {
    ...
    Sound sound1 = Gdx.audio.newSound(Gdx.files.internal("damage.mp3"));
    Sound sound2 = Gdx.audio.newSound(Gdx.files.internal("get.wav"));
    ...
    public GameScreen(JumpActionGame game) {
        ...
        mPrefs = Gdx.app.getPreferences("jp.techacademy.erika.takenoue.jumpactiongame");
    ...
    private void createStage() {
        ...
        while (y < WORLD_HEIGHT - 5) {
            ...
            if (mRandom.nextFloat() > 0.6f) {
                Enemy enemy = new Enemy(enemyTexture, 0,0,450,500);
